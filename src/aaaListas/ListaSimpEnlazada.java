...
public class ListaSimpEnlazada<E extends Comparable<E>> {
	...
	/*-----------INSERTAR NUEVO ELEMENTO EN CIERTA POS-----------*/
	...
	/*-----------SI ESTÁ ORDENADO PERO RECURSIVO-----------*/
	...
	/*-----------OBTENER EL INDICE DEL OBJETO PERO SI ESTÁ ORDENADO ES MÁS FÁCIL BUSCAR-----------*/
	...
	/*-----------CAMBIAR LALS POSICIONES DE CIERTOS NODOS-----------*/
