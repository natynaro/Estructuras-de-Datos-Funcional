...
public class NodoAVL <E extends Comparable<E>>{
	...
	//izquierda-derecha
	public int actualizarFe(NodoAVL<E> n) {
		if(n==null){
			return 0;
		}else {
	...
	public NodoAVL<E> getHijoI() {
		return hijoI;
	}

	public void setHijoI(NodoAVL<E> nodoB) {
		
		this.hijoI = nodoB;
		this.fe= alturaNodo(this.hijoI)-alturaNodo(this.hijoD);
	}

	public NodoAVL<E> getHijoD() {
		return hijoD;
	}

	public void setHijoD(NodoAVL<E> nodoB) {
		this.hijoD = nodoB;
		this.fe= alturaNodo(this.hijoI)-alturaNodo(this.hijoD);
	}
