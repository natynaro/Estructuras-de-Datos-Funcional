...
public class EjermplosClase {
	/*la pila acumula mientras se cumpla la condicion de no encontrar vocales. 
	 * cuando se deja de cumplir, lo vamos vaciando hacia el string resultado */
